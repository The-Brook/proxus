...
#Enchants the dirt
execute as @e[tag=dirt_structure_validated] run data merge entity @s {Item:{id:"minecraft:dirt",Count:1b,tag:{CanDestroy:["minecraft:void_air"],HideFlags:24,display:{Name:"{\"text\":\"Infinidirt\",\"color\":\"yellow\",\"italic\":false}"},Enchantments:[{id:"minecraft:infinity",lvl:1}]}}}
